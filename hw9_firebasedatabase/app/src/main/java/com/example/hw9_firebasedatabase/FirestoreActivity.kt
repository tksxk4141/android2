...
import com.example.hw9_firebasedatabase.databinding.ActivityFirestoreBinding
...
class FirestoreActivity : AppCompatActivity() {
    ...
    private fun queryItem(itemID: String) {
        itemsCollectionRef.document(itemID).get()
                .addOnSuccessListener {
                    ...
                    binding.checkInstock.isChecked = it["instock"] as Boolean
    ...
    private fun updatePrice() {
        ...
        itemsCollectionRef.document(itemID).update("instock", instock)
            .addOnSuccessListener { queryItem(itemID) }
    }
        ...
        itemsCollectionRef.whereEqualTo("instock", true).get()
                .addOnSuccessListener {
                    ...
                    AlertDialog.Builder(this)
                            .setTitle("Items which in stock = true")
